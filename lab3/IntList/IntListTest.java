...
public class IntListTest {
    ...
    public void testReverse()
    {
        ...
        IntList originalEmptyList = new IntList();
        IntList emptyList = new IntList();
        IntList reverseEmptyList = IntList.reverse(emptyList);
        assertEquals(res, reverseA);
        assertNotEquals(A, originalA);
        assertEquals(emptyList, reverseEmptyList);
    }
